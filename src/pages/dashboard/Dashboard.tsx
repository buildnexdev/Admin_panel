...
const SOCIALS = [
    ...
    {
        name: 'Email', handle: 'buildnexdev@gmail.com', href: 'mailto:buildnexdev@gmail.com',
        ...
        <div className="bnx-wrap">
            ...
            <div className="bnx-body">
                ...
                <div className="bnx-right">
                    ...
                    <a href="mailto:hello@buildnex.dev" className="bnx-cta">
                        <div className="bnx-cta-left">
                            <span className="bnx-cta-label">Ready to build something great?</span>
                            <span className="bnx-cta-email">hello@buildnex.dev</span>
                        </div>
